...
const checkBestPosition = async (place: any, positions: any) => {
    try {
        ...
        for (let i = 0; i < positions.length; i++) {
            if (place[positions[i] - 1].pieceId == "B-king") {
                console.log("THis is Inside this place[positions[i] - 1].pieceId == B-king", place[positions[i] - 1].pieceId)
                ...
                if (pieceCheckMapping[positions[i]]) {
                    pieceCheckMapping[positions[i]].forEach((item: any) => {
                        console.log("This is inside of forEach 1 ::::");
                        if (place[item.check - 1]?.pieceId?.split("-")[0] == "R") {
                            console.log("This is inside of forEach 1 :::: and inside Of R ::::");
                ...
                if (placeMapping[positions[i]]) {
                    placeMapping[positions[i]].forEach((index: any) => {
                        console.log("This is inside of forEach 2 ::::");
            ...
            } else if (placeMapping[positions[i]]) {
...
const checkBestPositionIsValidOrNot = async (tableData: any, data: any) => {
    try {
        ...
        if (currentCheckKillData) {
            if (currentCheckKillData.length == 1) {
                ...
                console.log("checkValidOrNotcheckValidOrNotcheckValidOrNotcheckValidOrNotcheckValidOrNotcheckValidOrNot")
